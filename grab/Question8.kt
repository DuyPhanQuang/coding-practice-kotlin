...
/** idea
This approach is ensures that we track the painting progress
and detect when a row or column is completely painted as per the problem statement.
Once any row or column is completely painted, we will be able to identify it by the count to the
width or height of the matrix.
**/

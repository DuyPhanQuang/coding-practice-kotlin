...
// the main logic of this solution is to increment the least significant digit first and then propagate any carry over to the more significant digits while ensuring that each digit remains within the range of 0 to 9.
